...
# Example of how to access a column name
# survey_categories$Demographics$Provider will give "Service Provider"

# Iterate through each category
#for (category_name in names(survey_categories)) {
#  cat("\nCategory:", category_name, "\n")
  
  # Retrieve the category list
#  category_list <- survey_categories[[category_name]]
  
  # Iterate through each column in the category
#  for (column_name in names(category_list)) {
#    column_value <- category_list[[column_name]]
    
    # Print or perform operations with category name and column name/value
#    cat("  Column Name:", column_name, "(", column_value, ")\n")
    
    # Example operation: print the summary of the column from survey_data
    # Replace survey_data with your actual data frame name
