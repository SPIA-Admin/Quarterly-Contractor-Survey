...
•	Communication and Support: Contractors seek improved communication, more support from the Contract Partner, especially for new contractors, and a desire to be listened to and act on contractor feedback more effectively.</p>",
    ...
    IndustryChangeImpact = list(
      ...
      response_summary = "<p>The responses to this survey question reflect a mix of apprehension and cautious optimism regarding the future of the logistics and delivery industry. Key concerns and anticipated changes include:
...
•	Inflation: Inflation is a concern for many, with fears that rising costs will not be matched by corresponding increases in compensation, impacting profitability.</p>",
      quote_of_intrest = "<span style='color:#E7A922; background-color:#E5E5DD; text-align:center;'>**\"*[Other shippers], and probably other smaller logistics companies, will continue to take share from [Contract Partner] because they are more efficient and changing more rapidly for the future.*\"**</span><br>"
    ),
...
•	Instances of Neglect and Inefficiency: Some contractors share specific instances that underscore their challenges, such as unpaid contingency work, mismanagement, and unmet promises from senior management. These experiences contribute to a feeling of being overburdened and underappreciated.</p>",
      quote_of_intrest = "<span style='color:#E7A922; background-color:#E5E5DD; text-align:center;'>**\"*We have several contracts. A Contractor about 5 hours away from us walked away from their contract with zero notice. We were asked to run contingency so we did... [Contract Partner] missed several payments to us and when we did get paid, it was always the wrong amount... Doing the contingency work hurt our overall service... We took all of the risk and ended up breaking even... We will never run contingency again.*\"**</span><br>"
    ),
