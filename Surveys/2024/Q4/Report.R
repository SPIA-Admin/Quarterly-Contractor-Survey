...
source(".\\Surveys\\2024\\Q4\\ReportHelper.R")
...
cairo_pdf("Quarterly_Contractor_Survey_2024_Q4.pdf", width = 11, height = 17, family = "Verdana", onefile = TRUE)
...
grid.text("2024 - Q4", y = unit(0.4, "npc"), gp = gpar(fontfamily = "Impact", col = "#E7A922", cex = 6.4))
